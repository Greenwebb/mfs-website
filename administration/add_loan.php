...
<head>
  ...
  <title>Add Loan || Mighty Finance </title>
  <!-- base:css -->
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="post" id="add_loan_form" action="includes/logic/add_loan.php" class="forms-sample" enctype="multipart/form-data">
                      ...
                      <div class="form-group col-6">
                        ...
                        <div class="input-group ">
                          <div class="input-group">
                            ...
                            <input required type="number" class="form-control" min="500" step="500" id="amount" name="amount" placeholder="amount" aria-label="amount">
                          </div>
                        </div>
                      </div>
                      <div class="form-group col-6">
                      ...
                      <div class="form-group col-6">
                        ...
                        <div class="input-group ">
                          <div class="input-group">
                            ...
                            <input required type="text" class="form-control" id="interest" name="interest" placeholder="interest" aria-label="interest">
                          </div>
                        </div>
                      </div>
                      <div class="form-group col-6">
                        ...
                        <div class="input-group ">
                          <div class="input-group">
                            ...
                            <input class="form-control" type="text" id="realese_date" name="monthlyr_date">
              ...
              <div class="card-header text-center h5">
                Documentation
                 ...
                 <div class="form-group col-4">
                      ...
                      <div class="form-group col-4">
                        <label for="exampleInputName1">document attachment</label>
                        <div class="input-group ">
                          <div class="input-group">
                            <div class="input-group-prepend">
                              <span class="input-group-text"><em class="mdi mdi-calendar"></em></span>
                      ...
                      <div class="form-group col-4">
                        ...
                        <div class="input-group ">
                          <div class="input-group">
                            ...
                            <textarea required class="form-control" type="text" id="desc" name="desc"></textarea> 
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <button type="submit" name="admin_loan" id="resultloans" class="btn btn-primary btn-block btn-lg mr-2">Submit</button>
                  </form>
                </div>
              </div>
            </div>
