    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Loan Arrears</h4>
              <?php
                                      ...
                                      <div class="card">
                                        <div class="card">
                                          <div class="card-body text-center">
                                            ...
                                            <button class="btn btn-danger btn-sm mt-3 mb-4"><?=$eligibility?></button>
                                            <button class="btn btn-info btn-sm mt-3 mb-4">Contact</button>
                                            <button class="btn btn-success btn-sm mt-3 mb-4">0 loans</button>
