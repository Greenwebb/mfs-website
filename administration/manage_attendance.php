	...
	<form action="" id="employee-attendance">
		<div class="row form-group">
			<div class="col-md-4">
				...
				<select id="employee_id" class="borwser-default select2 form-control ">
					<option value=""></option>
					<?php 
					$employee = $con->query("SELECT *,concat(lname,', ',fname,' ',middlename) as ename FROM employee order by concat(lname,', ',fname,' ',middlename) asc");
			...
			<div class="col-md-3">
				...
				<select id="type" class="borwser-default form-control custom-select">
