...
<head>
  ...
  <title>Change Password || Mighty Finance Solution</title>
  <!-- base:css -->
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <center>
                ...
                <h4>New Password Reset!</h4>
                <h6 class="font-weight-light">Input new password details.</h6>
              </center>
              <form method="post" action="includes/logic/reset.php" class="pt-3">
                 <center>
...
unset($_SESSION['account_error']);
               ...
               <div class="mt-3">
                <div class="form-group">
                  <input required type="password" minlength="8" name="pass1" class="form-control form-control-lg" id="otp" placeholder="New Password">
                </div>
                <div class="form-group">
                  <input required type="password" minlength="8" name="pass2" class="form-control form-control-lg" id="otp" placeholder="Confirm Password">
                </div>
              
               
                <div class="mt-3">
                  <button type="submit" name="change_password" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">SEND</button>
                </div>
                <div class="text-center mt-4 font-weight-light">
                  are you done? <a href="login.php" class="text-primary">Go to login</a>
                </div>
              </form>
            </div>
          </div>
