...
if (isset($_POST['submit'])) {
  ...
  $query = "INSERT INTO contact_page (fname, lname, email, phone, purpose, query)
    VALUES (?,?,?,?,?,?)";
  ...
  if ($stmt->execute()) {
    ...
    $body .= "</tr>";
    $body .= "<tr><td style='border:none;'><strong>Subject:</strong>You have Messeage from a new subscriber or potential customer {$fname.' '.$lname} , email addrress: {$from}</td></tr>";
    $body .= "<tr><td></td></tr>";
